...
export default function NavBarDash( {appearance, setAppearance} ) {
    ...
    const onAppearanceChange = () => {
        if (appearance == "light") {
            setAppearance("dark");
            updateAppearanceCookie("dark");
        } else {
            setAppearance("light");
            updateAppearanceCookie("light")
        }
    }
    ...
    return (
        <nav className="flex items-center justify-between h-16 px-4 border-b bg-background z-50 text-lg font-header">
            <a className="flex items-center gap-2 mr-6" href="/webapp/public">
                ...
                <span className="font-semibold text-2xl">Custom Chat | Dashboard</span>
            </a>

            <div className="hidden lg:flex items-center gap-6">
                <a className="cursor-pointer font-medium text-muted-foreground" type="button">Landing</a>
