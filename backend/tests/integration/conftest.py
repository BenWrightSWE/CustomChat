...
def auth_token(create_test_user, supabase_test_client):
    ...
    response = supabase_test_client.auth.sign_in_with_password(
        {"email": create_test_user["email"], "password": create_test_user["password"]}
    )
...
def sample_assistant_request():
    ...
    return {
        ...
        "user_input": "Where is UGA located?",
    }


@pytest.fixture
def sample_injectable_doc():
    return DocumentCreate(
        doc_name="integration_test_doc",
        file_name="integration_test_doc.txt",
        doc_type="text/plain",
        doc_size=100,
    )
    ...
    return [
        {
            ...
            "embedding": [
                ...
                0.11489870399236679,
                1.1911733150482178,
                0.060767289251089096,
                -0.03735719621181488,
                -0.5115689635276794,
                -0.23063109815120697,
                -0.030547289177775383,
                -0.09727822989225388,
                0.7354980111122131,
                0.8205254673957825,
                2.069653034210205,
                ...
                0.41427871584892273,
                -1.4009935855865479,
                0.011125201359391212,
                0.5026485919952393,
                -0.024664228782057762,
                0.1461648792028427,
                -0.2690960764884949,
                -0.1801953911781311,
                0.6441383957862854,
                -0.060089897364377975,
                -1.4737244844436646,
                0.29430723190307617,
                -0.5910605192184448,
                -0.10112383961677551,
                ...
                -0.4592723250389099,
                -1.3119746446609497,
                -0.001658670138567686,
                -0.0919320210814476,
                0.007719174958765507,
                -0.25976884365081787,
                0.010555394925177097,
                -0.0911039188504219,
                0.5636513829231262,
                -0.575100302696228,
                0.4816199839115143,
                ...
                0.23366422951221466,
                0.5123561024665833,
                0.030031051486730576,
                -0.005601151846349239,
                -0.23290382325649261,
                0.6907779574394226,
                1.0513684749603271,
                1.0253009796142578,
        ...
        {
            "chunk": "UGA is home to the Georgia Bulldogs.",
            "embedding": [
                -0.19597791135311127,
                2.3474390506744385,
                -3.8788936138153076,
                ...
                -0.0664094015955925,
                -0.2673574984073639,
                -0.013128062710165977,
                0.018153971061110497,
                0.83388751745224,
                1.2511178255081177,
                1.5761958360671997,
                -0.006859099958091974,
                -0.025276971980929375,
                0.022494053468108177,
                -0.2561042010784149,
                1.1264336109161377,
                -0.2146710902452469,
                -0.9104778170585632,
                ...
                -0.3505091071128845,
                0.6656734347343445,
                0.042453911155462265,
                -0.7474037408828735,
                0.3847429156303406,
                0.8111952543258667,
                0.2005889117717743,
                -0.028753681108355522,
                -0.4333645701408386,
                -0.38088881969451904,
                -0.07345619052648544,
                1.1985580921173096,
                ...
                0.018222998827695847,
                -0.8134859800338745,
                -1.2381024360656738,
                1.3712828159332275,
                -0.038869958370923996,
                0.9119501113891602,
                1.0292534828186035,
                0.16793300211429596,
                0.7872161865234375,
        ...
        {
            "chunk": "UGA is T75 in the US for Computer Science.",
            "embedding": [
                -0.06450355052947998,
                1.7459046840667725,
                -3.51315975189209,
                ...
                0.7840064167976379,
                0.029252104461193085,
                0.013769394718110561,
                0.8245062232017517,
                -0.4709676206111908,
                -1.981344223022461,
                0.29393434524536133,
                ...
                -1.7370078563690186,
                1.17384934425354,
                0.0047912513837218285,
                0.3920403718948364,
                0.26438671350479126,
                0.013662753626704216,
                1.3972055912017822,
                -0.8277958035469055,
                -0.5082212686538696,
                1.225606918334961,
                ...
                0.3887556493282318,
                -0.5119361877441406,
                -0.0011464721756055951,
                -0.4500018358230591,
                -0.34443214535713196,
                -0.055816132575273514,
                0.2619656026363373,
                0.6766859889030457,
                0.28659752011299133,
                -0.2748139202594757,
...
def created_document(client, auth_headers, created_bot, sample_txt_file):
    ...
    data = {"doc_name": "fixture_test", "doc_type": ".txt", "doc_size": 50}
